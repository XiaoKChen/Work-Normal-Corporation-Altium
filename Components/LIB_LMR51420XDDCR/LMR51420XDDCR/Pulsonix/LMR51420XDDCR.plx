...
//16635757/1717324/2.50/6/3/Integrated Circuit
...
(library Library_1
	...
	(symbolDef "LMR51420XDDCR" (originalName "LMR51420XDDCR")
	...
	(compDef "LMR51420XDDCR" (originalName "LMR51420XDDCR") (compHeader (numPins 6) (numParts 1) (refDesPrefix IC)
		)
		...
		(attachedSymbol (partNum 1) (altType Normal) (symbolName "LMR51420XDDCR"))
		...
		(attr "Manufacturer_Part_Number" "LMR51420XDDCR")
		(attr "Mouser Part Number" "595-LMR51420XDDCR")
		(attr "Mouser Price/Stock" "https://www.mouser.co.uk/ProductDetail/Texas-Instruments/LMR51420XDDCR?qs=vvQtp7zwQdN6fBqQU4azxw%3D%3D")
		(attr "Arrow Part Number" "LMR51420XDDCR")
		(attr "Arrow Price/Stock" "https://www.arrow.com/en/products/lmr51420xddcr/texas-instruments?utm_currency=USD&region=nac")
		(attr "Description" "Switching Voltage Regulators SIMPLE SWITCHER power converter 4.5-V to 36-V, 2-A, synchronous buck with 40-uA IQ")
		(attr "<Hyperlink>" "https://www.ti.com/lit/ds/symlink/lmr51420.pdf?ts=1663231243064")
		(attr "<Component Height>" "1.1")
		(attr "<STEP Filename>" "LMR51420XDDCR.stp")
