...
(library Library_1
	...
	(symbolDef "SC32S-12.5PF20PPM" (originalName "SC32S-12.5PF20PPM")
	...
	(compDef "SC32S-12.5PF20PPM" (originalName "SC32S-12.5PF20PPM") (compHeader (numPins 2) (numParts 1) (refDesPrefix Y)
		...
		(attachedSymbol (partNum 1) (altType Normal) (symbolName "SC32S-12.5PF20PPM"))
		...
		(attr "<Hyperlink>" "https://www.sii.co.jp/en/quartz/files/2013/03/SC-32S_Leaflet_e20151217.pdf")
		(attr "<Component Height>" "0.85")
		(attr "<STEP Filename>" "SC32S-12.5PF20PPM.stp")
